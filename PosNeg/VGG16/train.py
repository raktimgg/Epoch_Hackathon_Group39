...
# model.classifier[1] = nn.Conv2d(512, 1, kernel_size=(1,1), stride=(1,1)).to(device)
...
train_loader = torch.utils.data.DataLoader(
	datasets.ImageFolder('/home/scitech/Hackathon/PosNeg/data1/train',transform=data_transforms),
...
# 	transform=data_center)]), batch_size=64, shuffle=True, num_workers=1, pin_memory=use_gpu)
...
val_loader = torch.utils.data.DataLoader(
	datasets.ImageFolder('/home/scitech/Hackathon/PosNeg/data1/test',transform=data_transforms),
	batch_size=64, shuffle=True, num_workers=1, pin_memory=use_gpu)
