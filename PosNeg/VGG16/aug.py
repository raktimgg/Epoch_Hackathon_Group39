...
def random_brightness(image):
    ...
    if(is_list(image)):
        ...
        image_list=image
        for img in image_list:
            random_brightness_coefficient = 2* np.random.uniform(0.4,0.7) ## generates value between 0.0 and 2.0
...
def augment_random(image, aug_types="", volume='expand' ):
    ...
    aug_types_all=["random_brightness","add_shadow","add_snow","add_rain","add_fog","add_sun_flare","add_speed","add_autumn","random_flip"]
    if aug_types=="":
