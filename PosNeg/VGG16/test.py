...
model.load_state_dict(torch.load('/home/scitech/Inter_IIT_2021/Augmentation code/model_53_0.9992416582406471', map_location = 'cpu'))
...
print('F1 score =',f1_score(res,x2,average ='macro'))